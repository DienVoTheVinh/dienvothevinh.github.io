...
% --- MÀU SẮC THƯƠNG HIỆU VINHMATH ---
\definecolor{vmAccent}{HTML}{1E40AF}     % Xanh Navy tươi sáng - Điểm nhấn chính
\definecolor{vmAccentSoft}{HTML}{F0F6FF} % Nền xanh Navy nhạt
\definecolor{vmOk}{HTML}{C27D00}         % Vàng đậm - Cho bài tập & dạng toán
\definecolor{vmOkSoft}{HTML}{FFFDF0}     % Nền vàng nhạt
\definecolor{vmWarn}{HTML}{B5483A}       % Đỏ son Hanko - Điểm nhấn phụ / bài tập tự luyện
\definecolor{vmWarnSoft}{HTML}{FDF2F0}   % Nền đỏ nhạt
\definecolor{vmInk}{HTML}{1F1D1A}        % Mực Charcoal đen dịu (trên nền trắng)
\definecolor{vmBg}{HTML}{FFFFFF}         % Nền giấy trắng tinh khiết
\definecolor{vmLine}{HTML}{E2E8F0}       % Màu đường kẻ phân cách
\definecolor{warmgray}{HTML}{64748B}     % Xám Slate trung tính

% --- Đè màu chuẩn trong TikZ/LaTeX để đồng bộ thương hiệu VinhMath ---
\colorlet{blue}{vmAccent}      % Nét vẽ chính -> Navy Blue
\colorlet{green}{warmgray}     % Nét vẽ phụ/chú thích -> Xám
\colorlet{magenta}{vmAccent}   % Cung tròn góc thường -> Navy Blue
\colorlet{orange}{vmWarn}      % Góc cần tính/điểm nhấn -> Đỏ son
