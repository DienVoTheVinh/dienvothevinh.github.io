...
\newtheorem{vdlt}{\color{\mauVD}\damEX Ví dụ}
...
\listenumerate{dn,vd,vdlt,dl,tc,nx,ex,bt,vidu,ap}
...
% Thay đổi dấu phân ý (itemize) cấp 2 và 3 thành hình ngôi sao để tránh hiểu lầm thành dấu trừ trong toán học
\renewcommand{\labelitemii}{\color{\mauitemKN}\ensuremath{\star}}
\renewcommand{\labelitemiii}{\color{\mauitemCI}\ensuremath{\star}}
