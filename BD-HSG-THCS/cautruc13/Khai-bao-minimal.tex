...
\node[opacity=0.08] at (current page.center) {
    \includegraphics[width=10.5cm]{logo/VinhMath_logo.png}
};
...
\fancyhead[RE,LO]{\color{\maufoot}\sffamily\fontsize{9pt}{11pt}\selectfont\itshape VinhMath - Người Học là Trung Tâm}
...
\fancyfoot[CE,CO]{\color{warmgray}\fontsize{8.5pt}{11pt}\selectfont\faMapMarker\ \DC}
...
\fancypagestyle{plain}{%
    ...
    \fancyfoot[LE,RO]{\color{\maufoot}\fontsize{9pt}{11pt}\selectfont\sffamily Trang \thepage/\pageref{LastPage}}%
    \fancyfoot[CE,CO]{\color{warmgray}\fontsize{8.5pt}{11pt}\selectfont\faMapMarker\ \DC}%
    \fancyfoot[RE,LO]{\color{\maufoot}\fontsize{8.5pt}{11pt}\selectfont\sffamily\bfseries\itshape VinhMath - Người Học là Trung Tâm}%
}
