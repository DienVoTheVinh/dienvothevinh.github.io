...
function render(){
 ...
 $('vm-feedback').textContent='Đã kiểm tra tệp và chuyển đến trình tải xuống. Mở bộ cài để cài mới hoặc cập nhật; bài giảng và thiết lập được giữ lại.';
