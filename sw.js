...
const VM_CACHE = 'vinhmath-shell-v17';
const VM_PREVIOUS_POPUP_CACHE = 'vinhmath-shell-v16';
const VM_SHELL = [
  '/',
  '/index.html',
  '/dang-nhap.html',
          ...
          .then(function (windows) {
            return Promise.all(windows.map(function (client) {
              try {
                ...
                if (target.searchParams.get('vm_refresh') === '17') return null;
                target.searchParams.set('vm_refresh', '17');
