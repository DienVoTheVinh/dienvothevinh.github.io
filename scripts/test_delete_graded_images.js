...
assert(/canKhongCanTep = new Set\(\[[^\]]*"xoa_cham"/.test(edge) && /!canKhongCanTep\.has\(action\) && !files\.length/.test(edge), 'Edge Function vẫn bắt buộc upload tệp cho thao tác xóa.');
