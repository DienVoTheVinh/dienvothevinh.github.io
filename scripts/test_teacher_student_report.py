...
require(report, 'id="rowTests"', "Chi tiết chưa tách bài kiểm tra")
require(report, 'id="rowReviewed"', "Chi tiết chưa có số bài đã chấm được xem lại")
require(report, 'id="rowScoreDetail"', "Chi tiết chưa giải thích số kết quả đã nhập điểm")
