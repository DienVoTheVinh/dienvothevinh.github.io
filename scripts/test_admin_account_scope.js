...
for (const page of pages) {
  ...
  expect(html.includes("audience === 'student' ? TT_MAT_KHAU_HS_KHOI_TAO : ttMatKhauNgauNhien()"), `${page}: student-only initial password and random staff default are missing`);
